	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}			
					...
					\noindent \underbar{\textbf{UC21 - Odobravanje oglasa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Slanje oglasa na doradu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC23 - Odbijanje oglasa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC24 - Dodavanje kategorija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC25 - Dodavanje potkategorija}}
					\begin{packed_item}
